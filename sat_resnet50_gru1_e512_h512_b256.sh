...
#SBATCH --job-name="sat_resnet50_gru1_e512_h512_b256"
#SBATCH --output="sat_resnet50_gru1_e512_h512_b256.%j.%N.out"
#SBATCH --error="sat_resnet50_gru1_e512_h512_b256.%j.%N.out"
...
srun python train.py \
	--models_dir sat_resnet50_gru1_e512_h512_b256 \
